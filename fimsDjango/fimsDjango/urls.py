...
urlpatterns = [
    ...
    path('head/edit/<str:hashid>/', update_head, name='update_head'),
    path('state/edit/<str:hashid>/', edit_state, name='edit_state'),
    path('city/edit/<str:hashid>/', edit_city, name='edit_city'),
    path('add_state/', add_state, name='add_state'),
    path('add_city/', add_city, name='add_city'),
    path('view_family/<str:hashid>/', view_family, name='view_family'),
    path('view_state/<str:hashid>/', view_state, name='view_state'),
